...
#ifndef LECPATTERNS_TEMPLATEMETHOD_H
#define LECPATTERNS_TEMPLATEMETHOD_H

#include <iostream>

/**
 * Шаблонний метод — це поведінковий патерн проектування,
 * який визначає кістяк алгоритму,
 * перекладаючи відповідальність за деякі його кроки на підкласи.
 * Патерн дозволяє підкласам перевизначати кроки алгоритму,
...
#endif //LECPATTERNS_TEMPLATEMETHOD_H